...
const updateUserProfile = async (req, res) => {
  ...
  if (user) {
    ...
    // --- LOGIC CẬP NHẬT MỚI ---
    // Chỉ kiểm tra thời gian chờ khi người dùng thay đổi Tên hiển thị
    if (displayName && displayName !== user.displayName) {
      ...
      user.lastInfoChange = new Date(); // Chỉ cập nhật ngày khi tên thay đổi
    }

    // Cho phép thay đổi bio bất cứ lúc nào
    // Dùng 'bio || '' để cho phép người dùng xóa bio
    user.bio = bio || '';
